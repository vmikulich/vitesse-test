...
import PiecewiseFunctionEditor from '@/components/Paraview/widgets/PiecewiseFunctionEditor'
import PalettePicker from '@/components/Paraview/widgets/PalettePicker'
import TreeView from '@/components/Paraview/widgets/TreeView'
import { SPECTRAL } from '@/paraview/palette'
import Presets from '~/paraview/config/ColorMaps'
